    ...
    fetch(jsonBusiness)
        ...
        .then((jsObject) => {
            ...
            for (let i = 0; i < num; i++) {
                ...
                annualRevenue.innerHTML = "Annual Revenue: " + '<br />' + businessList[i].annualRevenue;
                ...
                website.textContent = businessList[i].website.slice(8, businessList[i].website.length - 1);
